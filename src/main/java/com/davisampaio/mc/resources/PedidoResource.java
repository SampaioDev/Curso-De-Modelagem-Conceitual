package com.davisampaio.mc.resources;
...
import com.davisampaio.mc.services.PedidoService;
...
public class PedidoResource {
	...
	public ResponseEntity<Void> delete(@RequestBody Pedido obj, @PathVariable Integer id) {
		service.delete(id);
